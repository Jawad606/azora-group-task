      ...
      >
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-16 gap-4">
            ...
            <p className="text-base md:text-lg lg:text-[20px] font-normal leading-relaxed w-full md:w-[600px] text-white/60 font-['Avenir_Next',system-ui,-apple-system,'Segoe_UI',Roboto,'Helvetica_Neue',Arial,'Noto_Sans',sans-serif]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 md:gap-5 mb-16">
            <FeatureItem
              image={featureTwo}
              title="Write code"
          ...
          <div className="text-center mb-20">
            <a
              href="#"
              className="inline-flex items-center text-white/80 hover:text-white transition-colors text-base gap-2"
            >
